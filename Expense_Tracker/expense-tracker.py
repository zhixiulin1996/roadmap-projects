...
def add_expense(description, amount, date_in=""):
    ...
    :param date_in: (str) the date of added expense in "yyyy/mm/dd" form
    :return: none
    """
...
def update_expense(expense_id, description=None, amount=None, date_in=None):
    ...
    :param date_in: (str) the date of updated expense in "yyyy/mm/dd" form
    :return: none
    """
    expenses = load_expenses()
    updated = False
...
def summary(year=None, month=None):
    ...
    if not year and month:
        ...
        print("Month should be an integer between 1 and 12.")
    else:
        if year:
            if month:  # summary year month
